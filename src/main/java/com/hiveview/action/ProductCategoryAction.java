...
public class ProductCategoryAction extends BaseController {
    ...
    public String list() {
        return "productCategory/category_list";
    }
    ...
    public ModelAndView page(HttpServletRequest request, ModelAndView mav) {
        ...
        mav.setViewName("productCategory/paging");
        return mav;
    }
...
//                }
    ...
    public ModelAndView toAdd(ModelAndView mav,@PathVariable("parentId") Long parentId) {
        ...
        mav.setViewName("productCategory/category_add");
        return mav;
    }
    /**
     * 去添加类目
    ...
    public ModelAndView toSetting(@PathVariable("id") long id,ModelAndView mav) {
        ...
        mav.setViewName("productCategory/setting");
        return mav;
    }
