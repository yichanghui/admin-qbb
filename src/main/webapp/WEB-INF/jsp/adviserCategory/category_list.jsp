...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 类目管理 <span class="c-gray en">&gt;</span> 顾问类目列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<script type="text/javascript">
	...
	$(function () {
		...
		$("button[name='addCategory']").click(function () {
			admin_edit('新建类目', '/adviserCategory/toAdd/0.html', '1', '800', '500');
		});
	});
