...
<!--[if lt IE 9]>
<script type="text/javascript" src="plugins/lib/html5shiv.js"></script>
<script type="text/javascript" src="plugins/lib/respond.min.js"></script>
<![endif]-->
...
<!--[if IE 6]>
<script type="text/javascript" src="plugins/h-ui.admin/lib/DD_belatedPNG_0.0.8a-min.js" ></script>
