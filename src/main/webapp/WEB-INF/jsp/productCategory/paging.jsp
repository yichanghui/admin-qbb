...
<table class="table table-border table-bordered table-bg">
    <thead>
    <tr>
        <th scope="col" colspan="9">产品类目列表</th>
    </tr>
    <tr class="text-c">
    ...
    <tr class="text-c">
        ...
        <%--<td>1</td>--%>
            ...
            <%--<td>--%>
                <%--<span class="color${category.level}">--%>
                <%--<c:if test="${category.type == 1}">产品类目</c:if>--%>
        ...
        <td class="td-manage">
            <a title="添加子类目" href="javascript:void(0);" onclick="admin_edit('添加子类目','/productCategory/toAdd/${category.id}.html','1','800','500')" class="ml-5" style="text-decoration:none">
                <i class="Hui-iconfont" style="color: blue;">添加子级类目</i>
            </a>
        </td>
        <td class="td-manage">
            <a title="编辑" href="javascript:void(0);" onclick="admin_edit('设置','/productCategory/toSetting/${category.id}.html','1','800','500')" class="ml-5" style="text-decoration:none">
    ...
    $(function () {
        $("a[name='delete']").click(function() {
            ...
            layer.confirm("您确定要删除此目录以及它的子目录吗？", {
                ...
                $.ajax({
                    type: "POST",
                    url: "/productCategory/delete.json",
                    data: {code:code},
                    dataType: "json",
